...
MERCHANTS = [
    ...
    {"name": "Namecheap", "url": "https://www.namecheap.com/cart"},
...
def attempt_checkout(card, merchant):
    ...
    try:
        ...
        # NOTE: Example field locators — may vary per merchant
        try:
...
def log_attempt(card, merchant, result):
    ...
    with open("multi_checkout_log.txt", "a") as f:
